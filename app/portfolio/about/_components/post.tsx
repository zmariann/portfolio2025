  ...
  return (
    <div>
      ...
      <Popup trigger={popup} setTrigger={setpopup}>
        <div className="w-[90vw] h-[80vh] sm:w-[70vw] sm:h-[50vh] md:w-[80vw] md:h-[30vh] mb-14 border-[1px] border-dark-shade  pl-5 py-3 pr-2 overflow-y-scroll scrollbar-hide overflow-scroll">
